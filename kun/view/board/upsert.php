        ...
        <form method="POST" name="board_form" id="board_form" action="/proc/">
            ...
            <div class="inner">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="" class="form-control" placeholder="수정 및 삭제에 사용됩니다." aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>

                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default">제목</span>
                    <input type="text" name="" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>

                <div class="form-floating">
                    <span class="input-group-text" id="inputGroup-sizing-default">내용</span>
                    <textarea class="form-control" name="" placeholder="내용을 입력해주세요" id="floatingTextarea2" style="height: 100px"></textarea>
                </div>
                <br>
